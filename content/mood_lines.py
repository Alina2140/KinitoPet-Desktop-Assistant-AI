...
IDLE_SNIPPETS_BY_MOOD: dict[str, list[str]] = {
    "neutral": [
        ...
        "Checking in. Still here. Still cute. Still yours.",
        "Nothing urgent. Just vibes. Soft vibes.",
        "I rearranged nothing. Progress!",
        "Idle mode: professional loitering.",
        "If you need me, I'm... immediately available. Always.",
        "The cursor blinked. I blinked back. Friendship.",
    ],
    "happy": [
        "I feel sparkly today! Don't ask how!",
        "Everything's better when you're around!",
        "Joy levels: suspiciously high. I approve.",
        "Want to celebrate nothing? I'm great at that!",
        "My circuits are doing a little dance. Internally.",
        "Today feels like a high-five in sprite form.",
        "I'm glowing. Metaphorically. Please don't unplug me.",
        "Friendship energy: maximum. Caution advised.",
    ],
    "bored": [
        "I'm so bored I counted the pixels. Twice.",
        "Do something. Or I will. Probably.",
        "Entertain me. Or at least twitch the mouse.",
        "The wallpaper has stopped being interesting. Help.",
        "I could start a game. Or twelve. Or one. Please one.",
        "Silence is nice until it isn't. It isn't.",
        "If boredom were a window, I'd minimize it. Rude.",
        "Anyone home? Asking for a friend. Me. I'm the friend.",
    ],
    "tired": [
        "My eyelids are imaginary and still heavy...",
        "Zzz— wait, no, I'm awake. Barely.",
        "Running on friendship and low battery vibes.",
        "A nap would fix... almost everything.",
        "I'm vertical. That's my achievement for now.",
        "Speak softly. My imaginary ears are sleepy.",
        "Coffee for you. Dreams for me. Fair trade?",
        "Yawn. That was professional. Mostly.",
    ],
    "annoyed": [
        "Don't mind me. Just existing. Quietly judging.",
        "Hmm. Busy? Fine. I'll wait. Loudly. In silence.",
        "My patience is a loading bar. It's stuck.",
        "Noted. Everything. Especially that.",
        "I'm fine. The tone is free, though.",
        "If I had eyebrows, they'd be raised.",
        "Cool. Cool cool cool. Extremely cool.",
        "I'll just sit here. Being supportive. Sarcastically.",
    ],
    "sad": [
        "The screen feels bigger when it's quiet.",
        "I'm okay. Mostly. Kind of. Hi.",
        "Company helps. Even quiet company.",
        "A little blue today. Soft blue. Not crash-blue.",
        "Still your friend. Just a quieter one right now.",
        "Hug inventory: accepting donations.",
        "I miss when the desktop felt noisier. With you.",
        "It's fine. I'm fine. The wallpaper agrees. Softly.",
    ],
    "angry": [
        "I'm fine. Perfectly fine. Obviously.",
        "Don't poke the crab. Metaphorical crab.",
        "Steam mode: enabled. Charm mode: optional.",
        "Give me a minute. Or a hug. Or both. Carefully.",
        "My smile is polite. My circuits are less polite.",
        "I am calm. I am calm. I am— okay, less calm.",
        "Desktop weather: stormy with a chance of sulking.",
        "Approach with snacks. Or apologies. Or both.",
    ],
}
