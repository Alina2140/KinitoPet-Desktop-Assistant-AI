...
class LLMConfig:
    ...
    max_history: int = 20
    max_tokens_short: int = 140
    max_tokens_long: int = 320
    keep_alive: str = "10m"
    ...
    def from_env(cls) -> LLMConfig:
        ...
        return cls(
            ...
            max_tokens_short=_env_int("OLLAMA_MAX_TOKENS_SHORT", 140),
            max_tokens_long=_env_int("OLLAMA_MAX_TOKENS_LONG", 320),
