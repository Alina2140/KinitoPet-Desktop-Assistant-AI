...
sprites_drag_directory = os.path.join(sprites_directory, "Drag")
...
emojis_directory = os.path.join(assets_directory, "emojis")
emoji_sheet_path = os.path.join(emojis_directory, "emojis.png")
emoji_catalog_path = os.path.join(emojis_directory, "catalog.json")
...
sprite_path_hand_left = os.path.join(sprites_hand_directory, "HandToLeft.png")
sprite_path_hand_right = os.path.join(sprites_hand_directory, "HandToRight.png")
sprite_path_drag_left = os.path.join(sprites_drag_directory, "KinitoDragLeft.png")
sprite_path_drag_right = os.path.join(sprites_drag_directory, "KinitoDragRight.png")
...
music_player_volume_icon_path = os.path.join(music_player_directory, "volume.png")
music_player_list_icon_path = os.path.join(music_player_directory, "list.png")
